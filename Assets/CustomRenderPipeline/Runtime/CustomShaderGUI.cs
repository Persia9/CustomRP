...
public class CustomShaderGUI : ShaderGUI
{
    ...
    //当前选中的material是数组形式，因为可以同时多选多个使用同一Shader的材质进行编辑
    private Object[] materials;
    private MaterialProperty[] properties;

    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        //绘制材质Inspector下原本所有的GUI，例如材质的Properties等
    ...
    {
        //ShaderGUI的FindProperty函数，返回一个名为name的MaterialProperty
    ...
    /// <summary>
    /// 因为之前在Lit.shader中使用Toggle标签的属性来切换关键字，因此在通过代码开关关键字时也要对Toggle操作以同步
    /// </summary>
